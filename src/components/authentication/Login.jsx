...
import { Tooltip } from "react-tooltip"; // ✅ keep this
// ❌ remove this line: import "react-tooltip/dist/tooltip.css";
        ...
        <div className="card-body">
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="form-control mt-4 flex content-center items-center justify-around">
              ...
              <Tooltip id="googleTip" place="bottom" />
            </div>
          </form>
